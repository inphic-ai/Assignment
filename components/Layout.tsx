...
import { LayoutDashboard, CheckSquare, FolderKanban, BookOpen, Settings, Plus, CalendarClock, Megaphone, AlertTriangle, Info } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ 
  ...
  const navItems = [
    ...
    { id: 'announcement', icon: Megaphone, label: '系統公告' }, // Added here
